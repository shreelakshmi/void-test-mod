...
public class CountTriples { //test
	...
	public static void fetchFileUrlFromDatabus() { //format
		...
		QueryExecution qexec = QueryExecutionFactory.sparqlService("https://databus.dbpedia.org/repo/sparql",queryString);
